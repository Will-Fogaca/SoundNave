...
const
  // Estados da janela de visualização de dados
  ESTADO_MANUAL = 1;
  ESTADO_HISTORIA = 2;
  ESTADO_PONTUACOES = 3;
...
begin
  ...
  dados_fase := dados;
  // Se o modo da janela for o de história
